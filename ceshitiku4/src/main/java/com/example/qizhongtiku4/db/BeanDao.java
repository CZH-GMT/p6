...
import com.example.ceshitiku4.Bean;
...
public class BeanDao extends AbstractDao<Bean, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Phone = new Property(2, int.class, "phone", false, "PHONE");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BEAN\" (" + //
                ...
                "\"NAME\" TEXT," + // 1: name
                "\"PHONE\" INTEGER NOT NULL ," + // 2: phone
                "\"SEX\" TEXT);"); // 3: sex
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Bean entity) {
        ...
        stmt.bindLong(3, entity.getPhone());
    ...
    public void readEntity(Cursor cursor, Bean entity, int offset) {
        ...
        entity.setPhone(cursor.getInt(offset + 2));
