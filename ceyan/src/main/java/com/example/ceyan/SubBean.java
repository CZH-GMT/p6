...
public class SubBean {
    ...
    private int visible;
    private int zan;
    @Generated(hash = 1904664751)
    public SubBean(Long mid, String apkLink, int audit, String author,
            ...
            boolean fresh, String host, int id, String link, String niceDate,
            String niceShareDate, String origin, String prefix, String projectLink,
            long publishTime, int realSuperChapterId, int selfVisible,
            long shareDate, String shareUser, int superChapterId,
